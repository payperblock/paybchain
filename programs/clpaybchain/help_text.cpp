...
You can check the contract's abi by using 'clpaybchain get code' command.)=====";
...
If you are currently using 'clpaybchain push action' command, try to add the relevant authority using -p option.)=====";
