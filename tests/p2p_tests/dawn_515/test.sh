...
b5idbios=`./programs/clpaybchain/clpaybchain -u http://localhost:8888 get block 5 | grep "^ *\"id\""`
b5id00=`./programs/clpaybchain/clpaybchain -u http://localhost:8889 get block 5 | grep "^ *\"id\""`
b5id01=`./programs/clpaybchain/clpaybchain -u http://localhost:8890 get block 5 | grep "^ *\"id\""`
