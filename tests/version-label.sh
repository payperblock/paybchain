#!/bin/bash
# The purpose of this test is to ensure that the output of the "nodpaybchain --version" command matches the version string defined by our CMake files
...
# get nodpaybchain version
ACTUAL=$($EOSIO_ROOT/build/bin/nodpaybchain --version) || : # nodpaybchain currently returns -1 for --version
# test
